<%-- 
    Document   : header
    Created on : Apr 27, 2023, 9:41:33 AM
    Author     : CAMPUS
--%>
        ...
        <div class="grid">
            ...
            <ul class="header__navbar-list">
              <li class="header__navbar-item header__navbar-item--has-notify">
                <a href="" class="header__navbar-item-link">
                  <i style="margin: 0 4px" class="fas fa-bell"></i>
                  Thông báo
                </a>
                <!-- Notification -->
              ...
              <li class="header__navbar-item">
                <a href="" class="header__navbar-item-link">
                  <i style="margin: 0 4px" class="far fa-circle-question"></i>
                  Trợ giúp
                </a>  
              </li>
               <!--Đăng nhập và đăng kí -->
               <c:if test="${sessionScope.myAccount == null}">
                <li id="signup" class="header__navbar-item header__navbar-item--strong header__navbar-item--separate">Đăng kí</li>
                <li id="login" class="header__navbar-item header__navbar-item--strong">Đăng nhập</li>                  
               </c:if>
                ...
                <ul class="header__navbar-user-menu">
                  <li class="header__navbar-user-item">
                    <a href="" class="header__navbar-user-item-link">
                      <i class="header__navbar-user-icon fa-solid fa-user"></i>
                  ...
                  <li class="header__navbar-user-item header__navbar-user-item-link--separate">
                    <a href="LogoutControl" class="header__navbar-user-item-link">
                      <i class="header__navbar-user-icon fa-solid fa-right-from-bracket"></i>
                      <span>Đăng xuất</span>
                    </a>
                  </li>
                </ul>
          ...
          <div class="header-with-search">
            <div class="header__logo">
              <a href="HomeControl" class="header__logo-link">
<!--                <svg viewBox="0 0 192 65" class="header__logo-img">
            ...
            <div class="header__search">
              <div class="header__search-input-wrap">
                  <input id="searchContent" type="text" class="header__search-input" placeholder="Nhập để tìm kiếm sản phẩm phù hợp">
                <!-- Search History -->
                <div class="header__search-history">
                  ...
                  <ul class="header__search-history-list">
                    <li class="header__search-history-item">
                      <a href="https://twitter.com/campus2k2">Giày Nike Xịn đẹp</a>
                    </li>
                    <li class="header__search-history-item">
                      <a href="">Nguyễn Hoàng Việt</a>
                    </li>
                    <li class="header__search-history-item">
                      <a href="">Bí kíp qua môn</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <button class="header__search-btn" onclick="callSearchServlet()">
